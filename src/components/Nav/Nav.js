...
class Nav extends Component{
	render(){
		...
		if (!this.props.admin.level){
			...
			titleLink = <Link to="/info"><img className="logo" src="/headtree1.jpg" alt="brainchangelogo"/><h2 className="nav-title">Brain <br /> Change</h2></Link>
			...
			titleLink = <Link to="/profile"><img className="logo" src="/headtree1.jpg" alt="brainchangelogo"/><h2 className="nav-title">Brain <br /> Change</h2></Link>
			...
			titleLink = <Link to="/myparticipants"><img className="logo" src="/headtree1.jpg" alt="brainchangelogo"/><h2 className="nav-title">Brain <br /> Change</h2></Link>
			...
			titleLink = <Link to="/allparticipants"><img className="logo" src="/headtree1.jpg" alt="brainchangelogo"/><h2 className="nav-title">Brain <br /> Change</h2></Link>
	    }
		return(
			<div className="nav">
				{titleLink}				
