        ...
        return (
            <div>
                ...
                <Paper justify="center"  className="paper">
                    ...
                    <div className="giph">
                        <iframe src="https://giphy.com/embed/MCFM4xcrVFYG4hQcmV" width="600" height="400" frameBorder="0" disabled="block" className="giphy-embed" allowFullScreen title="elimination5Instructions"></iframe>
                    </div>
